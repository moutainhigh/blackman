	...
	$.extend({
		progressBar: new function() {
			this.defaults = {
				...
				showText: true,
				width: 330,
				boxImage: '/images/active/coupon/barbg.png',
				barImage: {
					0: '/images/active/coupon/bar1.png',
					100: '/images/active/coupon/bar1.png',
					210: '/images/active/coupon/bar1.png'
				},
				height: 30
			};
			this.construct = function(arg1, arg2) {
				...
				return this.each(function(child) {
					...
					if (argpercentage != null && this.bar != null && this.config != null) {
						...
						if (argpercentage == null) var percentage = $this.html().replace("%", "");
						$this.html("");
