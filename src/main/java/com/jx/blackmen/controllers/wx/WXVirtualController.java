 ...
 *
 */
public class WXVirtualController extends BaseController {
	...
	public ActionResult list(){
		...
		return view("/wx/address/mvirlist");
	 ...
	 * @return
	 */
	@Path("/wx/address/detail/{id:\\d+}.html")
